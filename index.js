...
async function getData() {
  ...
  data.forEach((element) => {
    if (element.new && element.featured) {
      listContainer.innerHTML += `<li id="one${element.id}" class="job"><div class="developer-info">
    <img src="${element.logo}" alt="company's profile picture" class="profile-picture"/>
 <div class="details">
   ...
   <div class ="contract-group">
    ...
    <button class="level"> ${element.level}</button>
      ...
      listContainer.innerHTML += `<li id="${element.id}" class="job"><div class="developer-info">
...
<div class="company-group">  
    ...
    <div class="position-group"><p class="position"> ${element.position}</p></div>
    <div class="contract-group">
    <p class="posted-at"> ${element.postedAt}</p>
...
function listSkills(element) {
  const lis = document.querySelectorAll(".developer-expertise");
  let skill, tool;
